...
if not os.path.exists("./logs_KOR/"):
    os.mkdir("./logs_KOR/")
    
if not os.path.exists("./Script_KOR/"):
    os.mkdir("./Script_KOR/")
    
if not os.path.exists("./Planning_KOR/"):
    os.mkdir("./Planning_KOR/")

# Set up log file written format ex) 01:39:09
logging.basicConfig(
    format="%(asctime)s %(levelname)s: %(name)s: %(message)s",
    level=logging.DEBUG,
    filename='./logs_KOR/dm_KOR.log',
    # encoding='utf-8',
    datefmt="%H:%M:%S",
    #stream=sys.stderr,
)
...
path1 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class1'
model1 = load_model(path1)

path2 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class2'
model2 = load_model(path2)

path3 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class3'
model3 = load_model(path3)

path4 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class4'
model4 = load_model(path4)

path5 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class5'
model5 = load_model(path5)

path6 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class6'
model6 = load_model(path6)

path7 = './Working_code_KOR/saved_models_ext/DontStarve_PlannedSpeech_Model_Class7'
...
with open('settings_KOR.txt', 'r', encoding='utf-8') as settingsfile:
